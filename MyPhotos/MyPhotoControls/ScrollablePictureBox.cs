    ...
    public class ScrollablePictureBox : PictureBox
    {
        ...
        private void DrawImage(Graphics g)
        {
            ...
            if (SizeMode == PictureBoxSizeMode.CenterImage)
            {
                ...
                if (Right - VBar.Width > Image.Width)
                    p.X = Math.Max((ClientSize.Width
                    - targetRect.Width) / 2, 0);
                if (Bottom - HBar.Height > Image.Height)
                    p.Y = Math.Max((ClientSize.Height
        ...
        private bool ScrollingActive()
        {
            ...
            else
            {
                ...
                HBar.Visible = Image.Width
                >= ClientSize.Width - VBar.Width;
                VContainer.Visible = Image.Height
                >= ClientSize.Height - HBar.Height;
            }

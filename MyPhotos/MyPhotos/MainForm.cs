...
namespace MyPhotos
{
    public partial class MainForm : Form
    {
        ...
        private void mnuFileOpen_Click(object sender, EventArgs e)
        {
            ...
            ref path, ref password))
            {
                ...
                {
                    string msg = string.Format("Unable to open album the file {0}\n({1})",
                                              path, aex.Message);
 ...
 = AlbumController.AskForSave(Manager);
        ...
        private void ctxMenuPhoto_Opening(object sender, CancelEventArgs e)
        {
            ...
            slideShowToolStripMenuItem.Enabled = (Manager.Album != null && Manager.Album.Count > 0);
        }
        ...
        {
            using (mnuSlideShow dlg = new mnuSlideShow(Manager))
            {
                dlg.ShowDialog();
            }
        }

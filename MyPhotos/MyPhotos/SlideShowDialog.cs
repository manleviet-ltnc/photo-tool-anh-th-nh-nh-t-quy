...
namespace MyPhotos
{
    public partial class mnuSlideShow : Form
    {
        ...
        public mnuSlideShow(AlbumManager manager)
        {
        ...
        private void InitializeForm()
        {
            ...
            Bitmap bmp
            = MyPhotos.Properties.Resources.NextBitmap;
            bmp.MakeTransparent(Color.White);
            btnNext.Image = bmp;
            bmp
            = MyPhotos.Properties.Resources.PrevBitmap;
            bmp.MakeTransparent(Color.White);
            btnPrev.Image = bmp;
